...
if __name__ == "__main__":
    argparser = argparse.ArgumentParser(description = "Creates collocation info for the whole corpus. The script treats the corpus as a single file. The output is written to a csv with the name 'corpus_{search_string}.csv' in the output folder")
